...
pgPool.query(createTableQuery, (error) => {
  if (error) {
    console.error("Error creating employeeRegRequest table:", error);
  } else {
    console.log("employeeRegRequest table and indexes created or already exist");
  }
});
